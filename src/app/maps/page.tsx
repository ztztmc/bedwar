...
export default async function MapRotationPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto mt-2 p-4">
      <h1 className="text-8xl font-bold bg-linear-to-b from-foreground to-foreground/20 bg-clip-text text-transparent mb-1 pb-1">
        Map Rotation
      </h1>
      <div className="flex flex-col md:flex-row justify-between md:items-center text-muted-foreground">
        <p>The latest Hypixel Bedwars map rotation.</p>
        <a
          href="https://hypixel.net/threads/bed-wars-map-rotation-log.4441812/page-10"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className="flex items-center cursor-pointer bg-secondary hover:bg-secondary/80 gap-1 rounded-md transition-colors px-2 py-1">
            hypixel.net/threads/bed-wars-map-rotation-log...{" "}
